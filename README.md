...
Note that present Material-UI has an odd thing where MuiThemeProvider has been renamed to MuiThemeProviderOld, this has been undone manually in the muiapi.json, will see if there's another way of doing this in future.
