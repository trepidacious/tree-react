...
//           )(implicit ir: Reusability[A]): Component[A, Unit, Unit, CtorType.Props] = {
...
//    }
//    DataComponent[A](renderer, name, contexts)(ir)
//  }
//}
//
///**
...
//             contexts: ReactDataContexts = ReactData.defaultContexts,
//             onError: DataError => VdomElement = View.defaultError
//           )(implicit ir: Reusability[A]): Component[Cursor[A], Unit, Unit, CtorType.Props] = {
//
