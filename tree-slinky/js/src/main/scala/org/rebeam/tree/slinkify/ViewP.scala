...
//  def build(name: String)(implicit ir: Reusability[A]): Component[A, Unit, Unit, CtorType.Props] = {
...
//  def build(name: String, contexts: ReactDataContexts = ReactData.defaultContexts)(implicit ir: Reusability[A]): Component[Cursor[A], Unit, Unit, CtorType.Props] = {
...
//  def build(name: String, contexts: ReactDataContexts = ReactData.defaultContexts)(implicit irA: Reusability[A], irB: ImmutableReusability[B]): Component[(Cursor[A], Cursor[B]), Unit, Unit, CtorType.Props] = {
...
//
//  def build(name: String, contexts: ReactDataContexts = ReactData.defaultContexts)(implicit ir: Reusability[A]): Component[A, Unit, Unit, CtorType.Props] = {
//    ScalaComponent.builder[A](name)
//      .render_P(
//        a => contexts.transactor.consume(
//          tx => this.apply(a)(tx)
